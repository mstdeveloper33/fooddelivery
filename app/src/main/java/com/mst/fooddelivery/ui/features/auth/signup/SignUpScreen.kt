...
import com.mst.fooddelivery.ui.FoodHubTextField
...
fun SignUpScreen(viewModel: SignUpViewModel = hiltViewModel()) {
    Box(modifier = Modifier.fillMaxSize()) {
        // ViewModel'den kullanıcı bilgilerini ve UI durumunu alır.
        // CollectAsStateWithLifecycle kullanarak değişiklikleri takip eder.
        ...
        // UI durumunu ViewModel'den alır ve uygun şekilde günceller.
